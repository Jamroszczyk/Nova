...
def analysis():
    ...
    minimum = 2  # input("Choose lower cut for word length: ")
    ...
    output_words = input_words # [inflection.singularize(plural) for plural in input_words]  # Combines singulars and plurals into singulars
    ...
    if len(key_list) == 0:
        ...
        error_label.lower()
        inderror_label.lower()
        error_label.config(text=None, bg=None, fg=None, font=None)
        inderror_label.config(text=None, bg=None, fg=None, font=None)
